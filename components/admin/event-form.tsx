  ...
  return (
    <form action={formAction} className="max-w-xl space-y-4">
      ...
      <div>
        ...
        <Input id="slug" name="slug" required defaultValue={defaults?.slug} placeholder="annual-reunion-2026" maxLength={200} />
      </div>
      <div>
      ...
      <ImageUploadField name="posterUrl" label="Poster" defaultValue={defaults?.posterUrl ?? ""} folder="events" />
